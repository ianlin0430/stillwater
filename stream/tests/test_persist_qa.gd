...
func _initialize() -> void:
	...
	check(s.animals.size()==StreamWorld.new().state.animals.size() and s.animals[0].keys()==["id","name","parent","species"],"Summary lists alive animals with id/name/parent/species")
