extends RefCounted
# Long-run gates for the reef cast (2026-09-24), derived from the configured species and
# written down in docs/ecology.md "Acceptance gates" before any live run was judged.
